...
% handles    structure with handles and user data (see GUIDATA)
    ...
    set(handles.image_slider, 'Max', handles.last_image);
    set(handles.image_slider, 'SliderStep', [1/(handles.last_image-1) , 1/(handles.last_image-1) ]);
    ...
    imagesc(handles.image1{get(hObject,'Value')},'Parent',handles.axes1);
    imagesc(handles.image2{get(hObject,'Value')},'Parent',handles.axes2);
